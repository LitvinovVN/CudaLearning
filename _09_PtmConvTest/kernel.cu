...
#define BlockDimX 45 // Размерность блока по X задаём равной числу нитей в блоке
#define BlockDimY 14  /*25000*/ /*SharedMemorySize/BlockSizeX*/ // Размерность блока по Z от 1 до CudaCoresNumber
