...
#define BlockDimX 128 // Размерность блока по X задаём равной числу нитей в блоке
#define BlockDimY 5  /*25000*/ /*SharedMemorySize/BlockSizeX*/ // Размерность блока по Z от 1 до CudaCoresNumber
...
#define GridNy 30000 // Размерность расчетной сетки по оси y
