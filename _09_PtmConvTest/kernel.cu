...
#define BlockDimX 16 // Размерность блока по X задаём равной числу нитей в блоке
#define BlockDimY 40  /*25000*/ /*SharedMemorySize/BlockSizeX*/ // Размерность блока по Z от 1 до CudaCoresNumber
...
#define GridNy 15000 // Размерность расчетной сетки по оси y
